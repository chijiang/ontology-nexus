...
class ProductServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProduct = channel.unary_unary(
                '/work_ticket.ProductService/GetProduct',
        ...
        self.ListProducts = channel.unary_unary(
                '/work_ticket.ProductService/ListProducts',
...
def add_ProductServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'work_ticket.ProductService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('work_ticket.ProductService', rpc_method_handlers)
