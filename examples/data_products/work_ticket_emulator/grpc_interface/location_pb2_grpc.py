...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLocation = channel.unary_unary(
                '/work_ticket.LocationService/GetLocation',
        ...
        self.ListLocations = channel.unary_unary(
                '/work_ticket.LocationService/ListLocations',
...
def add_LocationServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'work_ticket.LocationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('work_ticket.LocationService', rpc_method_handlers)
